...
function App() {
 ...
 // const [dialogOpen, setDialogOpen] =useState(false);
  ...
  async function getTest() {
    // document에 대한 참조 생성
    const docRef = doc(db, "capstone design", "test");
    // 참조에 대한 Snapshot 쿼리
    ...
    <div className="App">
      <div className='bar'>
        ...
        <div className='login'>
          ...
          {/* <Button
          sx={{
            fontSize: isWideScreen ? 30 : 14,
            color: 'white',
            borderColor: 'white',
          }}
          variant='outlined'
          onClick={user ? ()=>setMyPageOpen(true) : ()=> setDialogOpen(true)}>
            Register
          </Button>
          <RegisterForm registerFunc={registerFunc} setDialogOpen={setDialogOpen} dialogOpen={dialogOpen}/> */}
        </div>
      </div>
      <div className='btns'>
